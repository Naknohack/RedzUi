...
local redzlib = {
	Themes = {
		Darker = {
			...
			["Color Hub 2"] = Color3.fromRGB(35, 25, 50),
		...
		Dark = {
			["Color Hub 1"] = ColorSequence.new({
				...
				ColorSequenceKeypoint.new(0.50, Color3.fromRGB(55, 40, 75)),
				ColorSequenceKeypoint.new(1.00, Color3.fromRGB(40, 30, 60))
			}),
			["Color Hub 2"] = Color3.fromRGB(50, 35, 70),
			["Color Stroke"] = Color3.fromRGB(80, 60, 110),
			["Color Theme"] = Color3.fromRGB(180, 60, 255),
		...
		Purple = {
			["Color Hub 1"] = ColorSequence.new({
				ColorSequenceKeypoint.new(0.00, Color3.fromRGB(45, 25, 65)),
				ColorSequenceKeypoint.new(0.50, Color3.fromRGB(70, 40, 100)),
				ColorSequenceKeypoint.new(1.00, Color3.fromRGB(45, 25, 65))
			}),
			["Color Hub 2"] = Color3.fromRGB(55, 30, 85),
			["Color Stroke"] = Color3.fromRGB(95, 55, 140),
			["Color Theme"] = Color3.fromRGB(190, 80, 255),
			["Color Text"] = Color3.fromRGB(240, 240, 240),
			["Color Dark Text"] = Color3.fromRGB(185, 185, 185)
		}
	}
},
	Info = {
