...
MapFrame.Position = UDim2.new(1, -200, 0.25, 0) -- tránh đè hub
...
Setting:AddButton({
    Name = "Fast Attack",
    Callback = function()
        loadstring(game:HttpGet("https://raw.githubusercontent.com/Naknohack/Suochaiyen/refs/heads/main/Fast"))()
    end
})
