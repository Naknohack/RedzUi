...
Status:AddButton({
    ...
    function()
        ...
        local url = "https://raw.githubusercontent.com/Naknohack/Hop/main/Fullmoon.json"

        _G.HopServerByAPI(url, function(v)
            return v.Players <= 6
        end)
    end
})
...
Status:AddButton({
    ...
    function()
        ...
        local url = "https://raw.githubusercontent.com/Naknohack/Hop/main/Darkbeard.json"
...
Status:AddButton({
    ...
    function()
        ...
        local url = "https://raw.githubusercontent.com/Naknohack/Hop/main/SwordLegendary.json"
