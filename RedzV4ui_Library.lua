...
function Library:SetTheme(NewTheme)
    ...
    SaveJson("bear library v8.1.json", Library.Save)
...
function Library:MakeWindow(Configs)
    ...
    MinimizedIcon = Create("ImageLabel", MinimizedContainer, {
        ...
        AnchorPoint = Vector2.new(0, 0.5),
        BackgroundTransparency = 1,
        Image = "rbxassetid://100306458933414",
...
local function CreateNotification(Icon, Title, Message, Duration)
    ...
    IconImage.Image = Icon or "rbxassetid://100306458933414"
...
function Library:SetUIBorderColor(color)
    if typeof(color) == "Color3" then
        self.Themes[self.Save.Theme]["UI Border Color"] = color
        if self.Save.Theme == Library.Save.Theme then
...
function Library:SetDiscordBorderColor(color)
    if typeof(color) == "Color3" then
...
function Library:SetProfileBorderColor(color)
    if typeof(color) == "Color3" then
...
function Library:SetHubColor(color)
    if typeof(color) == "Color3" then
...
function Library:SetStrokeColor(color)
    if typeof(color) == "Color3" then
...
function Library:SetToggleOnColor(color)
    if typeof(color) == "Color3" then
...
function Library:SetToggleOffColor(color)
    if typeof(color) == "Color3" then
...
function Library:SetToggleKnobOnColor(color)
    if typeof(color) == "Color3" then
...
function Library:SetToggleKnobOffColor(color)
    if typeof(color) == "Color3" then
...
function Library:SetToggleBorderColor(color)
    if typeof(color) == "Color3" then
...
function Library:SetBorderThickness(thickness)
...
function Library:GetBorderColors()
    return {
...
function Library:GetToggleColors()
    return {
...
function Library:ResetBorderColors()
...
function Library:ResetToggleColors()
    local defaultTheme = self.Themes.QuangHuy
