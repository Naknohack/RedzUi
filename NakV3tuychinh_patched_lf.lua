local function Translate(text)
    ...
    local url = "https://translate.googleapis.com/translate_a/single?client=gtx&sl=vi&tl="
        .. Language .. "&dt=t&q=" .. HttpService:UrlEncode(text)
...
Setting:AddDropdown({
        ...
        Default = (_G.SaveData["Language_Save"] == "vi" and "Vietnamese") or "English",
