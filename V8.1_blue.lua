...
local bearlib = {
    ...
    ["Color Discord Border"] = Color3.fromRGB(0,170,255),

    -- Card / Profile
    ["Color Profile Border"] = Color3.fromRGB(0,170,255),
    ["Color Card Border"] = Color3.fromRGB(0,170,255),
    ...
    ["Color Toggle Knob Off"] = Color3.fromRGB(120,120,120),
    ["Color Toggle Border"] = Color3.fromRGB(0,170,255),
...
Flag.Image = "rbxassetid://100306458933414"

-- logo vuông
Flag.Size = UDim2.fromOffset(28, 28)
