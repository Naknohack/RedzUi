...
function redzlib:MakeWindow(Configs)
	...
	ControlSize1.Position = UDim2.fromOffset(
		math.clamp(Pos1.X.Offset, 430, 1300),
		math.clamp(Pos1.Y.Offset, 200, 1100) -- ✅ từ 500 -> 900
	)
	
	ControlSize2.Position = UDim2.new(
		0, math.clamp(Pos2.X.Offset, 135, 380),
		1, 0
	)
	...
	function Window:SetScale(NewScale)
		if NewScale == "700" then
			NewScale = 700
		elseif NewScale == "450" then
			NewScale = 450
		elseif NewScale == "350" then
			NewScale = 350
		elseif NewScale == "300" then
			NewScale = 300
		end
