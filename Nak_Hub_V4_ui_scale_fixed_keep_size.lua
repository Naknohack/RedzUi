...
local vu32 = Library or redzlib or getgenv().redzlib

local function ApplyUiScale(option)
    local target = vu32
    if not target then return end

    local setScale = target.SetScale
...
local savedUiScale = GetSetting("UiScale_Save", "Bình thường")
...
FarmSettings:AddToggle({
    Name = "Kill Aura with my Dragon Strom",
    Default = false,
