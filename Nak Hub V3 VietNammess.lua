--  FIX LOAD + HOP (AUTO CHY TRC MI TH)
pcall(function()
    local HttpService = game:GetService("HttpService")
    local TeleportService = game:GetService("TeleportService")

    _G.HopServerByAPI = function(url, condition)
        print("HOP LOADED")
        ...
        for _, v in pairs(servers) do
            print("CHECK:", v.JobId, v.PlaceId)

            if condition(v) and v.JobId and v.PlaceId then
                table.insert(valid, v)
            end
        end

        if #valid == 0 then
            warn("NO VALID SERVER")
            return
        end

        local chosen = valid[math.random(1, #valid)]

        print("TRY HOP:", chosen.JobId)
...
Status:AddButton({
    "Hop Full Moon",
    function()
        print("CLICK FULLMOON")

        _G.HopServerByAPI(
            "https://raw.githubusercontent.com/Naknohack/Hop/main/Fullmoon.json",
            function(v)
                return true
            end
        )
...
Status:AddButton({
    "Hop Darkbeard",
    function()
        print("CLICK DARKBEARD")

        _G.HopServerByAPI(
            "https://raw.githubusercontent.com/Naknohack/Hop/main/Darkbeard.json",
            function(v)
                return true
            end
        )
...
Status:AddButton({
    ...
    function()
        ...
        _G.HopServerByAPI(
            "https://raw.githubusercontent.com/Naknohack/Hop/main/SwordLegendary.json",
            function(v)
                return true
            end
        )
