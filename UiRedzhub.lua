...
-- Cho file Function truy cập được Window
redzlib.Instances = redzlib.Instances or {}
redzlib.Instances.MainFrame = MainFrame

-- ===== RESIZE TAB =====

local ResizeTab = Instance.new("Frame")
ResizeTab.Name = "ResizeTab"
ResizeTab.Parent = MainFrame
ResizeTab.Size = UDim2.new(0,60,0,6)
ResizeTab.Position = UDim2.new(0.5,-30,1,-10)
ResizeTab.BackgroundColor3 = Color3.fromRGB(255,0,0)
...
ResizeTab.InputBegan:Connect(function(input)
	if input.UserInputType == Enum.UserInputType.MouseButton1 then
		resizing = true
		startY = input.Position.Y
		startScale = WindowScale.Scale
	end
end)

ResizeTab.InputEnded:Connect(function(input)
	if input.UserInputType == Enum.UserInputType.MouseButton1 then
		resizing = false
	end
end)
...
UIS.InputChanged:Connect(function(input)
	if resizing and input.UserInputType == Enum.UserInputType.MouseMovement then
		...
		local newScale = startScale - (delta / 500)
		newScale = math.clamp(newScale, 0.6, 1.5)
